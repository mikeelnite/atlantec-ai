...
def main():
    ...
    print("=" * 60)
    print("\nWelcome! This AI-powered assistant helps you discover Gaeltacht towns")
    print("(Irish-speaking regions) in Ireland. It can find nearby towns, pubs,")
    print("heritage sites, and volunteer opportunities using natural language.")
    print("\nFeatures:")
    print("  • Find Gaeltacht towns near any Irish county")
    print("  • Discover pubs and heritage sites near towns")
    print("  • Search for volunteer opportunities in specific areas")
    print("  • General web searches for Irish culture, events, etc.")
    print("  • Learn Irish words from town names")
    ...
    print('  "Find volunteer opportunities in Mayo Gaeltacht towns"')
    print('  "Irish language learning resources"')
